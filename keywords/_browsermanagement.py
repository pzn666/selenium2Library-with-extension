...
class _BrowserManagementKeywords(KeywordGroup):
    ...
    def property_should_be(self, property_value, expect_value):
        if property_value != expect_value:
            raise AssertionError("Property value should have been '%s' but was '%s'"
                                  % (property_value, expect_value))
        self._info("Property value is '%s'." % property_value)
